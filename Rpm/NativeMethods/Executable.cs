...
namespace Rpm.NativeMethods
{
    public class Executable
    {
        ...
        public ExecutableType IsExecutable(string fileName)
        {
            if (fileName == null)
            {
            ...
            if (File.Exists(fileName))
            {
                ...
                ptr = SHGetFileInfo(fileName, FileAttributes.Normal, ref fi, Marshal.SizeOf(typeof(SHFILEINFO)), SHGFI.EXETYPE);
