...
namespace AutoUpdaterDotNET
{
    internal partial class DownloadUpdateDialog : Form
    {
        ...
        private void WebClientOnDownloadFileCompleted(object sender, AsyncCompletedEventArgs asyncCompletedEventArgs)
        {
            ...
            try
            {
                if (asyncCompletedEventArgs.Error != null) throw asyncCompletedEventArgs.Error;

                if (_args.CheckSum != null) CompareChecksum(_tempFile, _args.CheckSum);
                ...
                else if (extension.Equals(".msi", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    if (!string.IsNullOrEmpty(installerArgs)) processStartInfo.Arguments += " " + installerArgs;
                }
