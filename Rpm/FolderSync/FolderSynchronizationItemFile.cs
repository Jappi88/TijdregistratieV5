...
namespace FolderSync
{
    ...
    public class FolderSynchronizationItemFile : FileOperation
    {
        ...
        {
            var id1 = string.IsNullOrEmpty(SourceFileName) ? 0 : SourceFileName.ToLower().GetHashCode();
            var id2 = string.IsNullOrEmpty(DestinationFileName) ? 0 : DestinationFileName.ToLower().GetHashCode();
            return id1 | id2;
        }
