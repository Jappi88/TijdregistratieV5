...
namespace ProductieManager.Rpm.Connection
{
     public class AutoDeskHelper
     {
         ...
         public static readonly string DownloadUrl = "http://valkvault01/AutodeskTC/valkvault01/Valk#/Entity/Details?id={0}&amp;itemtype=File";
         public static string GetTekeningPdfAsync(string artnr)
         {
             try
             {
