...
{
    public partial class NewCombineerForm : MetroBaseForm
    {
        ...
        public NewCombineerForm(Bewerking parent, Bewerking combi)
        {
            ...
            _parent = parent;
            _productie = combi;
            Text = $"Combineer [{_productie.ProductieNr}] {_productie.Naam} van {_productie.Omschrijving}";
            UpdateText();
            Invalidate();
        }
        ...
        private void xhoofdvalue_ValueChanged(object sender, EventArgs e)
        {
            UpdateText();
        }
        ...
        private void xok_Click(object sender, EventArgs e)
        {
            ...
            {
                XMessageBox.Show(this, "Kan productie niet combineren omdat het als is gecombineerd...", "Bestaat Al",
            ...
            if (xtotal + gcd >= 100)
            {
                ...
                XMessageBox.Show(this,
                    $"Er is geen ruimte meer om deze productie te combineren met {gcd}% aan activiteit...\n" +
                    $"Je hebt {extra}% meer ingevuld dan wat er gecombineerd kan worden.", "Geen Ruimte",
                    MessageBoxIcon.Exclamation);
                return;
            }
            ...
            if (xtotal + gcd >= 100)
            {
                ...
                XMessageBox.Show(this, $"De gekozen combi heeft al een combinaties van {xtotal}%!\n" +
                                       ...
                                       "Als je een productie combineert, dan dient de combinatie de resterede activiteit te kunnen opvangen.",
                    "Geen Ruimte", MessageBoxIcon.Exclamation);
                return;
            }
