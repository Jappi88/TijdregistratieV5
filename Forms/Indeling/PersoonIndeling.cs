...
namespace Controls
{
    ...
    public partial class PersoonIndeling : UserControl
    {
        ...
        public void UpdateLabelText()
        {
            ...
            {
                if (InvokeRequired)
                    BeginInvoke(new MethodInvoker(UpdateGebruikerInfo));
        ...
        public void UpdateGebruikerInfo()
        {
            ...
            else
            {
                ...
                if (Parent is GroupBox group)
                {
                    ...
                    {
                        group.Text = $"{Persoon.PersoneelNaam}";
                    }
                }
        ...
        private void PersoonIndeling_DragEnter(object sender, DragEventArgs e)
        {
            ...
            if (data != null && data.Controls.Count > 0 && data.Controls[0] is PersoonIndeling indeling &&
                indeling.Persoon != null)
            {
                BackColor = truecolor;
        ...
        private void xVerwijderKlus_Click(object sender, EventArgs e)
        {
            ...
            if (Persoon.IngezetAanKlus(SelectedBewerking, false, out var klusjes))
            {
                ...
                foreach (var wp in SelectedBewerking.WerkPlekken) wp.RemovePersoon(Persoon.PersoneelNaam);
                ...
                if (xpers != null)
                    if (xpers.IngezetAanKlus(SelectedBewerking, false, out var klusjes))
                    {
                        foreach (var klus in klusjes)
                            ...
                            {
                                klus.IsActief = true;
                                if (SelectedBewerking.State == ProductieState.Gestart) klus.Start();
