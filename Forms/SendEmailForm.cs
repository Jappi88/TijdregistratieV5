...
namespace Forms
{
    public partial class SendEmailForm : MetroBaseForm
    {
        ...
        private void xnieuweontvanger_Click(object sender, EventArgs e)
        {
            ...
            if (ontvangers.ShowDialog() == DialogResult.OK) InitOntvangers();
        }
        ...
        {
            var clients = new List<EmailClient>();
            ...
            {
                XMessageBox.Show(this,
                    "Afzender is niet ingevuld of is te kort om te verzenden!\nAfzender moet minstens 4 characters hebben.",
            ...
            {
                XMessageBox.Show(this,
                    "Bericht is te kort om te verzenden!\n\nBericht moet minstens 10 characters hebben.",
                    "Ongeldige Bericht", MessageBoxIcon.Exclamation);
                return;
            }

            RemoteProductie.SendEmails(clients, xonderwerp.Text, xafzender.Text, xmessagebox.Text, attachments, true,
                false);
            Close();
        }
    }
