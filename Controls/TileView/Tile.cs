...
namespace Controls
{
    public partial class Tile : MetroTile
    {
        ...
        public Tile()
        {
            ...
            flatbutton.Location = new Point(Width - 16, Height - 32);
            var xcontext = new ContextMenuStrip();
            xcontext.Opening += Xcontext_Opening;
            xcontext.Items.Add(new ToolStripMenuItem("Tile Wijzigen", Resources.Tile_colors_icon_32x32,
                TileChangeClicked));
            ...
            SelectedBox.Click += (x, y) => PerformClick();
            SuspendLayout();
        ...
        private void UpdateSelectedImageLocation()
        {
            ...
            SelectedBox.Location =
                new Point(Size.Width / 2 - SelectedBox.Width / 2, Size.Height / 2 - SelectedBox.Height);
        }
        ...
        {
            if (!AllowTileEdit) return;
            if (Parent is TileViewer table && Tag is TileInfoEntry entry)
            {
        ...
        private void Xcontext_Opening(object sender, CancelEventArgs e)
        {
